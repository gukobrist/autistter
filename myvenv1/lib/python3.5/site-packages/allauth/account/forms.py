...
class LoginForm(forms.Form):
    ...
    remember = forms.BooleanField(label=_("Запомнить меня"),
                                  required=False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            login_widget = forms.TextInput(attrs={'type': 'email','placeholder':('E-mail address'),'autofocus': 'autofocus',})
...
class BaseSignupForm(_base_signup_form_class()):
    ...
    def __init__(self, *args, **kwargs):
        ...
        username_field = self.fields['логин']
